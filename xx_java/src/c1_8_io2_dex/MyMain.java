...
public class MyMain {
	...
	static String path="src/c1_8_io2_dex/";
    public static void main(String[] args) throws Exception {
    	...
    	File tempFileApk = new File(path+"source/apk/temp");
    	...
    	File tempFileAar = new File(path+"source/aar/temp");
