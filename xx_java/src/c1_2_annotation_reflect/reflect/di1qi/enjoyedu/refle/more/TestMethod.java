...
//    xx_java/src/c1_2_annotation_reflect/reflect/di1qi/enjoyedu/refle/more/Person.java
    public static void main(String[] args) throws Exception {
        new TestMethod().testMethod();
    }
    /*方法相关*/
    public void testMethod() throws Exception{
        Class clazz = Class.forName("c1_2_annotation_reflect.reflect.di1qi.enjoyedu.refle.more.Person");
